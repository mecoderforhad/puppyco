  ...
  return (
    <>
      ...
      <nav className="crypto-menu">
        ...
        <a href="#pricing" className="active-click">
          Invite & Earn
        </a>
      ...
      <main>
        <div className="invite-container">
          ...
          <div className="referral-box">
            ...
            <p>
              Share this link with friends and earn $20 when they sign up and
      ...
      <footer>
        <div className="footer-text">
          © 2023 PuppyCo Crypto Platform | Invite friends and grow together
        </div>
      </footer>
    </>
  );
